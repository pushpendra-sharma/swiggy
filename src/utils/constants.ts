...
export const GET_ALL_RESTAURANT_URL =
  '/api/restaurants/list/v5?lat=28.52572220267605&lng=77.39057801663876&page_type=DESKTOP_WEB_LISTING';

export const GET_RESTAURANT_DETAIL_URL =
  '/api/restaurants/menu/v4/full?lat=28.52572220267605&lng=77.39057801663876&menuId=';
